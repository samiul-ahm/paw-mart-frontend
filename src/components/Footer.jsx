...
const Footer = () => {
  return (
    <footer className="sm:footer-horizontal bg-neutral text-neutral-content p-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8    lg:gap-5 justify-between ">
        <div>
