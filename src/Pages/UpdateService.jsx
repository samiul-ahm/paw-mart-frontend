...
const UpdateService = () => {
  ...
  return (
    <div>
      ...
      >
        <h2 className="text-2xl font-bold text-center">Update Pet / Product</h2>
        ...
        <div>
          ...
          <select name="category"  defaultValue={service?.category} className="w-full border p-2 rounded">
            <option>Pets</option>
            <option>Food</option>
        ...
        <div>
          ...
          <input
            type="number" defaultValue={service?.price}
            name="price"
        ...
        <div>
          ...
          <input
            type="text" defaultValue={service?.location}
            name="location"
            className="w-full border p-2 rounded"
          />
        </div>
        ...
        <div>
          ...
          <input
            type="url"
            name="image" defaultValue={service?.image}
            className="w-full border p-2 rounded"
          />
        </div>
        ...
        <div>
          ...
          <input
            type="date" defaultValue={service?.date}
            name="date"
            className="w-full border p-2 rounded"
          />
        </div>
